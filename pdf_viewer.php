...
<div class="panel">
   <div class="form-group">
		<div class="form-group row rigacodice">
			<label for="pdfname">PDF Name:</label>
			<div class="col-md-3">
			    <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
				  <input class="form-control toupper js-kioskboard-input" type="text" name="pdfname" id="pdfname" placeholder="'LANDSCAPE' or 'PORTRAIT'">
				</div>
			</div>
			<div class="border d-flex align-items-center justify-content-center" style="height: 100%;">
				<button type="button" id="bottonevedidisegno" class="btn btn-info">VIEW PDF</button>
			</div>
		</div>
   </div>
...
function viewPDF()
{
	 var url="<?php print CONFIG_BASE_URL ?>/ajax/get_pdf_files.php?filename="+$("#pdfname").val();		   
     // alert(url);
	 PDFViewerApplication.open(url);
	 
}
$( document ).ready(function() {
	$(".toupper").keyup(function(e){
		this.value = this.value.toUpperCase();
	});
	
	
			
	$("#pdfname").keydown(function(e){
	...
	$("#bottonevedidisegno").click(function(){
		viewPDF();
	});
	
				
     $.keyboard.keyaction.VIEW = function(base) {
		//chiudere la tastiera.....da fare!
$('.ui-keyboard').blur();
